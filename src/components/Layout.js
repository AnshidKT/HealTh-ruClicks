...
import logo from '../components/nav/doctor/image/Minimalist_Hospital_and_Medical_Health_Logo-removebg-preview.png'
    ...
    <div className='main-navbar'>
        <nav className='nav-main'>
            <ul className='nav-bar'>
              ...
              <Link to='/'><img style={{width:80,height:80}} src={logo} alt="" /></Link>
